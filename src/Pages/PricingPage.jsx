...
export default function PricingPage() {
  ...
  const handleUpgradePremium = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        toast.warn(data.message || "Failed");
        return;
      }
  ...
  const handleStartFree = async () => {
    try {
      ...
      if (!dataCheck.isPremium && dataCheck.remainingDays === undefined) {
        toast.info("You are already in Free plan");
        return;
      }
  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        >
          <h2 className="text-2xl font-semibold mt-4">Free (Starter)</h2>
          ...
          <ul className="space-y-2 mb-6 text-sm grow">
            ...
            <li className="flex items-center gap-2">
              <FaCheckCircle className="text-green-500" /> Task System: Todo /
              Running / Done
            </li>
            <li className="flex items-center gap-2">
              <FaCheckCircle className="text-green-500" /> Task Limit: 50 per
              project
            </li>
            <li className="flex items-center gap-2">
              <FaCheckCircle className="text-green-500" /> Task Character Limit:
              500
            </li>
        ...
        >
          ...
          <h2 className="text-2xl font-semibold mt-4">Premium</h2>

          <h3 className="text-3xl font-bold mb-6">$9 /month</h3>
          ...
          <ul className="mb-6 space-y-2 text-sm grow">
            ...
            <li className="flex items-center gap-2">
              <FaCheckCircle className="text-green-500" /> Unlimited Team
              Members
            </li>
            <li className="flex items-center gap-2">
            ...
            <li className="flex items-center gap-2">
              <FaCheckCircle className="text-green-500" /> Project Discussion
              System
            </li>
            <li className="flex items-center gap-2">
              <FaCheckCircle className="text-green-500" /> Member Remove /
              Control
            </li>
            <li className="flex items-center gap-2">
              <FaCheckCircle className="text-green-500" /> Deadline Reminder
              (Email + Notification)
            </li>
            <li className="flex items-center gap-2">
            ...
            <li className="flex items-center gap-2">
              <FaCheckCircle className="text-green-500" /> Unlimited Task
              Characters
            </li>
            <li className="flex items-center gap-2">
              <FaCheckCircle className="text-green-500" /> File Attachment
              (20MB)
            </li>
          </ul>
